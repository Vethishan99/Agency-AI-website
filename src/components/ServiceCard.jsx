...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <div
      className="relative overflow-hidden max-w-1g m-2 sm:m-4 rounded-xl border
...
dark: shadow-white/10"
    ...
    >
      ...
      <div className="flex items-center gap-10 p-8 hover:p-7.5 hover:m-0.5 transition-all rounded-[10px] bg-white dark:bg-gray-900 z-10 relative">
        <div className="bg-gray dark:bg-gray-700 rounded-full">
          <img
            src={service.icon}
            alt=""
            className="max-w-24 bg-whit dark:bg-gray-900 rounder-full m-2"
          />
        </div>
