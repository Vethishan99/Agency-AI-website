...
const Hero = () => {
  return (
    <div
      id="hero"
      className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 x1:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white"
    >
